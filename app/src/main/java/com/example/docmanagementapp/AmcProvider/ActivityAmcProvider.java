package com.example.docmanagementapp.AmcProvider;
...
import com.example.docmanagementapp.databinding.ActivityAmcProviderBinding;

import java.util.ArrayList;

public class ActivityAmcProvider extends AppCompatActivity {
ActivityAmcProviderBinding binding;
AdapterAmc adapterAmc;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityAmcProviderBinding.inflate(getLayoutInflater());
