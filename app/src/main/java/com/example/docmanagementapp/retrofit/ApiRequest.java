...
//            @Path("id") int id,
//            @Query("provider_cat_id") int p_cat_id,
...
//            @Query("p_cat_id") int p_cat_id
//);
//    @Headers({"Accept: application/json"})
//@POST("add-portfolio")
//    Call<AddPortfolioResponse> AddPortfolio(
//            @Header("Authorization") String auth,
//            @Body AddPortfolio add
//            );
//
//    @Headers({"Accept: application/json"})
//@POST("delete-portfolio")
//    Call<DeleteResponse> delPortfolio(
//            @Header("Authorization") String auth,
//            @Query("id") int id,
//            @Query("p_cat_id") int p_cat_id
//            );
...
//
//    @Headers({"Accept: application/json"})
//    @PUT("toggle-user-business/{id}")
//    Call<UpdateResponse> updateavailiblity(
//            @Header("Authorization") String auth,
//            @Path("id") int id
//    );
//
...
//    Call<UpdateResponse> delete(
//            @Header("Authorization") String auth,
//            @Query("p_cat_id") int id
//    );
//
//    @Headers({"Accept: application/json"})
//    @POST("chatheads")
//    Call<ChatResponse> chatheads(
//            @Header("Authorization") String auth,
//            @Query("sender_id") int id
//    );
//
//    @Headers({"Accept: application/json"})
//    @GET("user-business/")
...
//    Call<RechargeResponse> renew(
//            @Header("Authorization") String auth,
//            @Query("p_cat_id") String p_cat_id
//    );
//
//    @Headers({"Accept: application/json"})
//    @POST("payment-status-check")
//    Call<TransactionStatusResponse> getTractionStatus(
//            @Header("Authorization") String authorization,
//            @Body TransactionModel transactionModel
//            //  @Path("package_id") int id
//    );
//
//    @Headers({"Accept: application/json"})
...
//            @Body Nurse nurse
//    );
//    @POST("japa-maid/update")
//    Call<MaidJoinJapaResponse> UPDATEJapa(
//            @Header("Authorization") String auth,
...
//    @Headers({"Accept: application/json"})
//    @POST("user-fcm")
//    Call<FCMResponse> AddFCM(
//            @Header("Authorization") String auth,
//            @Query ("fcm_token") String fcm
//    );
