package com.example.docmanagementapp.utils;
...
public class SharedPref {
    ...
    private static final String LOGIN_SHARED_FILE = "Zaroori_Prefs";
    ...
    final  public  String lati="lati";
    final public String longi="long";
    final public String contact_admin="help";
